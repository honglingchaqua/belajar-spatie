    ...
    <div class="bg-white min-h-[calc(100vh-64px)] flex flex-col">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-grow flex flex-col">
            ...
            <div class="flex-grow flex flex-col space-y-6 sm:space-y-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        ...
                        <div class="p-4 sm:p-6">
                            <div class="flex items-center justify-center mb-4 sm:mb-6">
                                <div class="bg-blue-100 text-blue-600 p-3 sm:p-4 rounded-full">
                                    <svg class="h-8 w-8 sm:h-12 sm:w-12" fill="none" stroke="currentColor"
                            ...
                            <div class="text-center">
                                <a href="{{ route('403') }}"
                                    class="inline-block bg-blue-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-blue-600 transition duration-300 transform hover:-translate-y-1 shadow-md text-sm sm:text-base">
                                    Pesan Sekarang
                                </a>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="p-4 sm:p-6">
                            ...
                            <div class="text-center">
                                <a href="#"
                                    class="inline-block bg-green-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-green-600 transition duration-300 transform hover:-translate-y-1 shadow-md text-sm sm:text-base">
                                    Pesan Sekarang
                                </a>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="p-4 sm:p-6">
                            ...
                            <div class="text-center">
                                <a href="#"
                                    class="inline-block bg-purple-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-purple-600 transition duration-300 transform hover:-translate-y-1 shadow-md text-sm sm:text-base">
                                    Pesan Sekarang
                                </a>
                            </div>
                        </div>
                ...
                <div class="mt-auto">
                    <a href="#"
                        class="block w-full bg-blue-500 text-white px-6 py-3 sm:py-4 rounded-lg text-center text-base sm:text-lg font-semibold hover:bg-green-600 transition duration-300 transform hover:-translate-y-1 shadow-md">
                        Masukan Barang
                    </a>
                </div>
